...
NUM_CLASSES = 80
BATCH_SIZE = 1
OUTPUT_SIZE = BATCH_SIZE * 8400 * (NUM_CLASSES + 5)
    ...
    while l_frame is not None:
        ...
        while l_user is not None:
            ...
            for i in range(tensor_meta.num_output_layers):
                ...
                box_vector = np.ctypeslib.as_array(box_ptr, shape=(OUTPUT_SIZE, ))
                box_vector = np.reshape(box_vector, (BATCH_SIZE, 8400, (NUM_CLASSES + 5)))
                print(box_vector[0, 0, :10])
